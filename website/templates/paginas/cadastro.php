...
<nav class="panel top">
  <div class="sections desktop">
    ...
    <div class="center">
     ...
     <div class="right"><a class="button blue gradient" href="login">login</a></div>
    ...
    <div class="container">
      ...
      <div class="wrap">
        ...
        <div class="fix-6-12">
          ...
          <h1 class="huge ae-1 margin-bottom-2">Cadastro</h1>
        
          <br>
          

          <form action="/criar/"method="post" autocomplete="off" class="slides-form margin-bottom-3">
            {% csrf_token %}
            ...
            <button type="submit" class="button green gradient ae-4" name="submit">criar</button>
