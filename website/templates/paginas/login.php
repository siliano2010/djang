...
<nav class="sidebar" data-sidebar-id="1">
  ...
  <div class="content">
    ...
    <ul class="social opacity-8">
      <li><a href="#"><svg><use xmlns:xlink="http://www.google.com" xlink:href="#facebook"></use></svg></a></li>
...
<section class="slide fade-6 kenBurns">
    ...
    <div class="container">
      ...
      <div class="wrap">
        ...
        <div class="fix-6-12">
          ...
          <h1 class="huge ae-1 margin-bottom-2">Login</h1>
        
          <br>
          

          <form action="/entrar/"method="post" autocomplete="off" class="slides-form margin-bottom-3">
            {% csrf_token %}
            <input type="email" class="ae-3" name="email" placeholder="E-mail "/>
            <input type="password" class="ae-3" name="senha" placeholder="Senha"/>
            <br>
            <h6 class="ae-6 uppercase bold  small opacity-100" style="color:red">{{fail}}</h6>
            <button type="submit" class="button green gradient ae-4" name="submit">Entra </button>
            
          </form>
         

          <a href="#" ><button  class="button red gradient ae-4" name="submit">Esqueci a senha</button></a>
          <a href="cadastro" ><button  class="button blue gradient ae-4" name="submit">Criar conta</button></a>
  ...
  <div class="background" style="background-image:url({% static 'website/' %}assets/img/background/img-95.jpg)"></div>
</section>
<!-- Panel Bottom #01 -->
...
<div class="dropdown share bottom right" data-dropdown-id="2" data-text="Take a look at this" data-url="https://designmodo.com" data-pinterest-image="https://designmodo.com/wp-content/uploads/2015/10/Presentation.jpg">
  ...
  <ul>
    <li class="social-facebook"><svg><use xmlns:xlink="http://www.google.com" xlink:href="#fb-like"></use></svg></li>
