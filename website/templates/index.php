...
<head>
  ...
  <link rel="icon" href="{% static 'website/' %}assets/img/icon/icon.png">
	<!-- Page Title -->
	<title>home</title>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	...
	<!-- Compressed Styles -->
	<link href="{% static 'website/' %}css/slides.min.css" rel="stylesheet" type="text/css">
	...
	<!-- Compressed Scripts -->
	<script src="{% static 'website/' %}js/slides.min.js" type="text/javascript"></script>
...
<nav class="panel top">
  ...
  <div class="sections desktop">
    ...
    <div class="left"><a href="#" title="Slides Framework">logo aqui</a></div>
    ...
    <div class="right"><a class="button blue gradient" href="login">login</a><a class="button green gradient" href="#">Get App</a></div>
  
  
  </div>
  <div class="sections compact hidden">
    <div class="left"><a href="#" title="Slides Framework">logo mobile</a></div>
...
<nav class="sidebar" data-sidebar-id="1">
  ...
  <div class="content">
    ...
    <a href="#" class="logo"><a href="#" title="Slides Framework">logo aqui</a>
...
<section class="slide fade-6 kenBurns">
      ...
      <div class="wrap">
        ...
        <div class="fix-12-12">
          <ul class="flex fixedSpaces verticalCenter reverse">
            ...
            <li class="col-6-12">
             <!-- <img class="ae-4" data-action="zoom" width="605" src="{% static 'website/' %}assets/img/1.jpg"  />-->
              <iframe class="ae-4" data-action="zoom" width="560" height="315" src="https://www.youtube.com/embed/JlBAEKRzidw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </li>
          </ul>
        </div>
  ...
  <div class="background" style="background-image:url({% static 'website/' %}assets/img/background/topo.jpg)"></div>
</section>
...
<nav class="panel bottom forceMobileView">
  <div class="sections desktop">
    <div class="left"><a href="#" class="opacity-8">Available <svg style="height:21px;"><use  xlink:href="#apple"></use></svg> iPhone</a></div>
...
<div class="dropdown share bottom right" data-dropdown-id="2" data-text="Take a look at this" data-url="https://designmodo.com" data-pinterest-image="https://designmodo.com/wp-content/uploads/2015/10/Presentation.jpg">
  ...
  <ul>
    <li class="social-facebook"><svg><use  xlink:href="#fb-like"></use></svg></li>
    ...
    <li class="mail" data-subject="Subject" data-body="Body">share by oh email</li>
  </ul>
</div>
